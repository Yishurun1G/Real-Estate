    ...
    <div className='absolute top-0 left-0 w-full z-10'>
      <div className="container mx-auto flex justify-between
       items-center py-4 px-6 md:px-20 lg:px-32 bg-transparent">
        ...
        <img onClick={()=> setMobileMenu(true)} src={assets.menu_icon} className='nd:hidden w-7 cursor-pointer' 
        alt="" />
      </div>
...
<a onClick={()=> setMobileMenu(false)} href="#Header" className='px-4 py-2 rounded-full
inline-block '>Home</a>
<a onClick={()=> setMobileMenu(false)} href="#About" className='px-4 py-2 rounded-full
inline-block '>About</a>
<a onClick={()=> setMobileMenu(false)} href="#Projects" className='px-4 py-2 rounded-full
inline-block '>Projects</a>
<a onClick={()=> setMobileMenu(false)} href="#Testimonials" className='px-4 py-2 rounded-full
